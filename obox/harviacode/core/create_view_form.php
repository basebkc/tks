...
$string .= "\n\t    <tr><td colspan='2'><button type=\"submit\" class=\"btn btn-primary tombolsimpan\"><?php echo \$button ?></button> ";
...
$string .= "\n\t
        ...
        $hasil_view_list = createFile($string, $target."views/" . $c_url . "/" . $v_form_file);
?>
