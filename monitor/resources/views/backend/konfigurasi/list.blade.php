    ...
    <div class="row">
        <div class="col-md-12">
            <div id="panel-1" class="panel">
                ...
                <input id="judul" type="hidden" value="konfigurasi">  
                <div class="panel-container show">
                    <div class="panel-content">
                        ...
                        <table class="table table-striped table-bordered" id="tabelNasabah">
                            <thead>
                                ...
                                @foreach ($data as $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            {{-- <button class="btn btn-warning" data-toggle="tooltip" data-placement="top" data-animation="false" data-original-title="Edit" onclick="javascript:getModalEdit({{ $item->id }})" id="{{ $item->id }}"><i class="fal fa-edit"></i></button> --}}
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
                ...
                <form id="form" enctype="multipart/form-data"  novalidate class="was-validated">
                    ...
                    <div class="form-row">
                        <div class="col-md-12 mb-2">
                            <label class="form-label" for="customControlValidation1">Kode <span class="text-danger">*</span></label>
                            <input class="form-control" name="kode" id="kode" type="text" required placeholder="Kode">
                            <div class="invalid-feedback">
                                Tolong input Kode.
                            </div>                                            
                        </div>
                        <div class="col-md-12 mb-2">
                            <label class="form-label" for="customControlValidation2">No Sender <span class="text-danger">*</span></label>
                            <input class="form-control"  name="nosender" id="nosender" type="text" required placeholder="No Sender">
                            <div class="invalid-feedback">
                                Tolong input Isi.
                            </div>                                                                                 
                        </div>
                        <div class="col-md-12 mb-2">
                            <label class="form-label" for="customControlValidation2">Isi <span class="text-danger">*</span></label>
                            <textarea class="form-control" rows="5" name="isi" id="isi" type="text" required placeholder="Isi"></textarea>
                            <div class="invalid-feedback">
                                Tolong input Isi.
                            </div>                                                                                 
                        </div>
...
<script src="{{asset('assets/js/custom/konfigurasi.js') }}"></script>
