...
use App\Http\Controllers\TksController;
...
Route::get('/', function(){
	...
	// Route::get('', [TksController::class, 'index']);
});
...
// Route::middleware(['auth:sanctum', 'verified'])->group(function () {
	...
	Route::prefix('/tks')->group( function (){
		
		Route::get('', [TksController::class, 'index']);
		Route::post('/hitung', [TksController::class, 'getHitungData']);
		Route::get('/report/ldr/{tgl}/{kodekantor}/{carahitung}', [ReportController::class, 'ldrpdf']);
		Route::get('/report/cr/{tgl}/{kodekantor}/{carahitung}', [ReportController::class, 'crpdf']);
		Route::get('/report/car/{tgl}/{kodekantor}/{carahitung}', [ReportController::class, 'carpdf']);
	...
	Route::prefix('/setting')->group( function (){
		...
		Route::get('/likuid', [SettingController::class, 'index']);
		Route::get('/getdataldr', [SettingController::class, 'getdataldr']);
