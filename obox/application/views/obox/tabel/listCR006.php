...
<table width="100%" class="table-bordered table-striped" id="tableCR006">
    <thead>
        <tr>
            ...
            <td>Suku<br>Bunga</td>
            <td>Perhitungan<br>Suku Bunga</td>
            <td>Plafond</td>
            <td>Pladond<br>Efektif</td>
            <td>Baki<br>Debet</td>
    ...
    <tbody>
        <?php $no=1; foreach($hasil as $items) { ?>                    
            <tr>
                ...
                <td><?php echo $items['tanggal_jatuh_tempo'] ?></td>
                <td><?php echo $items['jenis_debitur'] ?></td>
                <td><?php echo $items['sektor_ekonomi'] ?></td>
                <td><?php echo $items['kategori_usaha'] ?></td>
                <td><?php echo $items['suku_bunga'] ?></td>
                <td><?php echo $items['perhitungan_suku_bunga'] ?></td>
                <td><?php echo number_format($items['jml_pinjaman'], 2); ?></td>
                <td><?php echo number_format($items['jml_pinjaman_efektif'],2) ?></td>
