...
class Ion_auth
{
		...
		if ($this->ion_auth_model->forgotten_password($identity))
		{
			...
			if ($user)
			{
				...
				else
				{
					...
					// 	'smtp_port'=> 465,
					// 	'smtp_user'=> 'bprbabakan47@gmail.com',
					// 	'smtp_pass'=> 'bprbabakan@47',
					// 	'mailtype' => 'html',
					// 	'charset'	=> 'iso-8859-1'
					// 	 );
	 ...
	 * @author Mathew
	 */
	public function register($id_groups,$identity, $password, $email, $additional_data = array(), $group_ids = array())
	{
		$this->ion_auth_model->trigger_events('pre_account_creation');

		$email_activation = $this->config->item('email_activation', 'ion_auth');

		$id = $this->ion_auth_model->register($id_groups,$identity, $password, $email, $additional_data, $group_ids);
