...
<main id="js-page-content" role="main" class="page-content">
    ...
    <div class="subheader">
        <h1 class="subheader-title">
            <i class='subheader-icon fal fa-table'></i> Tabel <span class='fw-300'>Ideb Nasabah Pengajuan Kredit</span> 
          </h1>
    </div>
    <div class="row">
        <div class="col-md-12">
            <div id="panel-1" class="panel">
                ...
                <div class="panel-container show ">
                    <div class="panel-content">
                        ...
                        <div class="panel-container show">
                            <div class="panel-content">
                                <table class="table table-striped table-bordered" id="tabelIdeb">
                                    <thead>
                                    ...
                                    <tbody>
                                        @php($no=1)
                                        @foreach($ideb ?? '' as $datas)
                                        <tr>
                                            <th scope="row">{{ $no++ }}</th>
                                            <td>{{ $datas->kode_kantor }}</td>
                                            <td>{{ $datas->nopengajuan }}</td>
                                            <td>{{ $datas->nik }}</td>
                                            <td>{{ $datas->tgllahir }}</td>
                                            <td>{{ $datas->generateslik }}</td>
